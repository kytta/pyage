...
def test_fingerprint():
    ...
    assert key.fingerprint("MD5") == "MD5:d3:9f:fc:84:80:ed:99:73:1c:1b:e4:77:ef:15:53:1a"
    assert (
        key.fingerprint_line("MD5")
        == "256 MD5:d3:9f:fc:84:80:ed:99:73:1c:1b:e4:77:ef:15:53:1a age (ED25519)"
    )
    assert key.fingerprint("SHA256") == "SHA256:d1NMPpXeiZSB8mrreniR7FmPcu2Hoa9eWAxmJx6zVno"
    assert (
