...
def test_fingerprint():
    ...
    assert key.fingerprint("MD5") == "MD5:d4:78:51:9c:ba:fe:28:8d:3f:98:ef:8e:f3:94:b6:59"
    assert (
        key.fingerprint_line("MD5")
        == "1024 MD5:d4:78:51:9c:ba:fe:28:8d:3f:98:ef:8e:f3:94:b6:59 age (RSA)"
    )
    assert key.fingerprint("SHA256") == "SHA256:vHkzEqesZd0/v84gmumHX/W8Pv2wkqfa37fJtHc//ak"
    assert (
