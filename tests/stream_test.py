...
def test_pack_nonce():
    assert _pack_nonce(0x03, False) == bytes.fromhex("00 00 00 00 00 00 00 00 00 00 03 00")
    assert _pack_nonce(0x5544332211, False) == bytes.fromhex("00 00 00 00 00 00 55 44 33 22 11 00")
    assert _pack_nonce(0x5544332211, True) == bytes.fromhex("00 00 00 00 00 00 55 44 33 22 11 01")
